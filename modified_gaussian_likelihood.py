...
class _GaussianLikelihoodBase(Likelihood):
    ...
    def expected_log_prob(self, target: Tensor, input: MultivariateNormal, *params: Any, **kwargs: Any) -> Tensor:
        ...
        ### original line of code -- comment for gaussian likelihood/uncomment for multitask gaussian likelihood###
    ...
    def marginal(self, function_dist: MultivariateNormal, *params: Any, **kwargs: Any) -> MultivariateNormal:
        ...
        noise_covar = self._shaped_noise_covar(torch.Size([covar.size(0)]), *params, **kwargs)
